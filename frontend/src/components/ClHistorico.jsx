...
function Paginacao({ paginaAtual, totalPaginas, onMudarPagina }) {
  ...
  // Estilo padronizado para Anterior/Próximo
      ...
      <table className="min-w-full divide-y divide-gray-200 mt-6 **table-fixed**">
        <thead>
          <tr className="text-left text-sm font-semibold text-gray-700 uppercase tracking-wider">
            ...
            <th className="py-3 pl-8 pr-2 **w-1/3**">Profissional</th>
          ...
          {consultas.map((consulta) => (
            ...
            >
              ...
              <td className="py-4 pl-2 pr-8 text-sm font-medium **text-center**">
                <button
                  //  visual do botão de opções
                  className="text-indigo-500 hover:text-indigo-800 p-2 text-lg rounded-full **bg-indigo-100/50** transition duration-150 ease-in-out"
                >
                  i
                </button>
              </td>
...
export default function App() {
  ...
  return (
    <div className="App flex bg-gray-100 min-h-screen">
      ...
      <div className="p-8 bg-white rounded-xl shadow-lg w-full max-w-x6l">
        {}
